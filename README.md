...
* 🧠 Strong foundation in DBMS, Operating Systems & OOPs
* 🚀 Building AI-powered real-world applications
* 🌱 Exploring MLOps, Computer Vision & Model Deployment
* 🎯 Aspiring Machine Learning Engineer, Data Scientist & Data Analyst
...
NumPy • Pandas • Scikit-Learn • OpenCV • MLflow

### 📊 Data Science & Analytics

**Tools & Concepts:**
Matplotlib • Seaborn • Plotly • Power BI • EDA • Statistical Analysis • Feature Engineering • Predictive Modeling
...
Data Structures & Algorithms • Object-Oriented Programming (OOPs) • Database Management Systems (DBMS) • Operating Systems (OS) • Computer Networks (CN) • Software Engineering
...
AI-powered surveillance drone capable of human detection and monitoring for security and defense applications.

### 🛡️ GuardX

Smart AI-powered security monitoring system using Computer Vision and real-time threat detection.

### 🩺 Pediatric Pneumonia Detection

Deep Learning model for pneumonia detection using Chest X-ray images.

### 📈 End-to-End ML Pipeline

Machine Learning workflow with experiment tracking, model management, and deployment.
